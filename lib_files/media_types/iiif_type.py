...
from lib_files.media_types.digital_objects.iiif_digital_object import IIIFDigitalObject
from lib_files.media_types.metadata.iiif_metadata import IIIFMetadata
