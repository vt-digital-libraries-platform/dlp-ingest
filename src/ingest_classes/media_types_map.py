import os
from src.ingest_classes.iiif_type import IIIFType
from src.ingest_classes.three_d_type import ThreeDType
from src.ingest_classes.pdf_type import PDFType
