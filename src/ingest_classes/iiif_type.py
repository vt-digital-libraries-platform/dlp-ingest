...
from src.ingest_classes.digital_objects.iiif_digital_object import IIIFDigitalObject
from src.ingest_classes.metadata.iiif_metadata import IIIFMetadata
