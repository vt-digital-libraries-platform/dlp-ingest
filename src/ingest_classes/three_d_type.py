...
from src.ingest_classes.digital_objects.three_d_digital_object import ThreeDDigitalObject
from src.ingest_classes.metadata.three_d_metadata import ThreeDMetadata
