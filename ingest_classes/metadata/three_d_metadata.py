...
class ThreeDMetadata(GenericMetadata):
    ...
    def set_archive_options(self, archive_dict):
        ...
        archive_assets["env_config"] = os.path.join(self.env["APP_IMG_ROOT_PATH"],"federated/3d/gltf/studio.env") #"https://img.cloud.lib.vt.edu/federated/3d/gltf/studio.env"
